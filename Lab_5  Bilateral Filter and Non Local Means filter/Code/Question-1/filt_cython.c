 ...
 */
          ...
          __pyx_v_g2r = fabsf(((*((float *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_im.data + __pyx_t_24 * __pyx_v_im.strides[0]) ) + __pyx_t_25 * __pyx_v_im.strides[1]) ) + __pyx_t_26 * __pyx_v_im.strides[2]) ))) - (*((float *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_im.data + __pyx_t_27 * __pyx_v_im.strides[0]) ) + __pyx_t_28 * __pyx_v_im.strides[1]) ) + __pyx_t_29 * __pyx_v_im.strides[2]) )))));
 ...
 */
          ...
          __pyx_v_g2g = fabsf(((*((float *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_im.data + __pyx_t_29 * __pyx_v_im.strides[0]) ) + __pyx_t_28 * __pyx_v_im.strides[1]) ) + __pyx_t_27 * __pyx_v_im.strides[2]) ))) - (*((float *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_im.data + __pyx_t_26 * __pyx_v_im.strides[0]) ) + __pyx_t_25 * __pyx_v_im.strides[1]) ) + __pyx_t_24 * __pyx_v_im.strides[2]) )))));
 ...
 */
          ...
          __pyx_v_g2b = fabsf(((*((float *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_im.data + __pyx_t_24 * __pyx_v_im.strides[0]) ) + __pyx_t_25 * __pyx_v_im.strides[1]) ) + __pyx_t_26 * __pyx_v_im.strides[2]) ))) - (*((float *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_im.data + __pyx_t_27 * __pyx_v_im.strides[0]) ) + __pyx_t_28 * __pyx_v_im.strides[1]) ) + __pyx_t_29 * __pyx_v_im.strides[2]) )))));
